...
export default function MobileBottomNav() {
  ...
  const navItems = [
    {
      ...
      svg: (isActive: boolean) => (
        <svg 
          ...
          stroke="currentColor" 
          viewBox="0 0 24 24"
          style={{ color: isActive ? primaryLightColor : '#94a3b8' }}
        >
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-xl border-t border-slate-800/50 z-50 safe-area-bottom">
            ...
            {item.primary ? (
              ...
              <div className="flex flex-col items-center justify-center gap-1 transition-all">
                ...
                <span 
                  ...
                  style={{ color: item.active ? primaryLightColor : '#64748b' }}
                >
                  {item.label}
                </span>
